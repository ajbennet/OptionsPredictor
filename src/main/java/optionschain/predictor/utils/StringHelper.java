...
public class StringHelper {
	...
	/**
	 * Checks that String is OK Or throws Runtime Exception
	 * 
	 * @param str
	 */
	...
	/**
	 * Prints the current Line, From the Stack trace, so we can tab to it in
	 * eclipse.
	 *
	 */
	 ...
	 * 
	 * @param markers
	 *            Set of character markers to search for in String
	 * @param arg
	...
	/**
	 * Encrypts a String (Used for storing / saving passwords)
	 * 
	 * @param s
	 *            String to Encrypt
	...
	/**
	 * Decrypt a String (Used for storing / saving passwords)
	 * 
	 * @param s
	 *            String to decrypt
	...
	/**
	 * Copies a File (Reads all bytes from first file, and writes all bytes to
	 * second File)
	 * 
	 * 
	 * @param source
	...
	/**
	 * View String in notepad Writes String to a temporary file, then view
	 * 
	 * @param content
	 *            String to view
	 */
	...
	/**
	 * Chops certain number of characters off the end of a String
	 * 
	 * @param str
	 *            String to Chop
	 * @param choplength
	 *            length of characters to remove from end of String
	...
	/**
	 * Returns an Arraylist as a String (seperated by NewLine)
	 * 
	 * @param alist
	 *            ArrayList to convert to String
	...
	public static long getChecksum(byte[] ba) throws IOException {
		...
		try {
			// Compute Adler-32 checksum
			cis = new CheckedInputStream(new ByteArrayInputStream(ba), new Adler32());
			byte[] tempBuf = new byte[1024];
			while (cis.read(tempBuf) >= 0) {
			}
			return cis.getChecksum().getValue();
	...
	/**
	 * Converts an ArrayList to a String Each entry is seperated by seperator
	 * 
	 * @param alist
	 *            ArrayList to convert to String
	 * @param seperator
	...
	/**
	 * Converts an Array to String Each entry seperated by NEWLINE
	 * 
	 * @param obj
	 *            object to convert
	...
	/**
	 * Convert a String to ArrayList Each line in the String is Read, and
	 * becomes and the line is added to the ArrayList
	 * 
	 * @param str
	 *            String to convert
	...
	/**
	 * Converts a Long to a String 1234567 will be 1,234,567
	 * 
	 * @param l
	 *            long to convert
	...
	/**
	 * Formats an integer as String for example, Returns First N lines of a
	 * String
	 * 
	 * @param n
	 *            length of field for Integer
	...
	/**
	 * Set Max Length of String Handles null values.
	 * 
	 * @param orig
	 *            Original String
	 * @param maxlength
	 ...
	 * @param fill
	 *            Character to fill, if need to increase length of String
	 * @return
	 */
	...
	/**
	 * Extracts a file to String If the file exists, Extract file as String
	 * Otherwise try to extract resource with same name as File.
	 * 
	 * 
	 * @param File
	 *            (or resource) to extract for
	 ...
	 * @param oldval
	 *            Old String to Search
	 * @param newval
	 *            new String to search for
	...
	public static String replaceAll(String orig, String oldval, String newval) {
		if (oldval.equals("")) {
			throw new RuntimeException("Invalid old value, length is zero ");
		}
		if (orig.indexOf(oldval) < 0) {
			return orig;
		}
